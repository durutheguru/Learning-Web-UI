...
pub mod calculator_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn square(
            &mut self,
            request: impl tonic::IntoRequest<super::SquareRequest>,
        ) -> std::result::Result<tonic::Response<super::SquareResponse>, tonic::Status> {
            self.inner
                .ready()
                .await
                .map_err(|e| {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/calculator.Calculator/Square",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("calculator.Calculator", "Square"));
...
pub mod calculator_server {
    ...
    pub trait Calculator: Send + Sync + 'static {
        async fn square(
            &self,
            request: tonic::Request<super::SquareRequest>,
        ) -> std::result::Result<tonic::Response<super::SquareResponse>, tonic::Status>;
    }
    #[derive(Debug)]
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/calculator.Calculator/Square" => {
                    ...
                    struct SquareSvc<T: Calculator>(pub Arc<T>);
                    impl<T: Calculator> tonic::server::UnaryService<super::SquareRequest>
                    for SquareSvc<T> {
                        type Response = super::SquareResponse;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as Calculator>::square(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
